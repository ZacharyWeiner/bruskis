  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created brew as @brew" do
        post :create, {:brew => valid_attributes}, valid_session
        expect(assigns(:brew)).to be_a(Brew)
        expect(assigns(:brew)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved brew as @brew" do
        post :create, {:brew => invalid_attributes}, valid_session
        expect(assigns(:brew)).to be_a_new(Brew)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested brew" do
        brew = Brew.create! valid_attributes
        put :update, {:id => brew.to_param, :brew => new_attributes}, valid_session
        brew.reload
    ...
    context "with invalid params" do
      it "assigns the brew as @brew" do
        brew = Brew.create! valid_attributes
        put :update, {:id => brew.to_param, :brew => invalid_attributes}, valid_session
        expect(assigns(:brew)).to eq(brew)
      end
